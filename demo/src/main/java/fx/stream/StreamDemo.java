...
public class StreamDemo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //1,2,3
        // 0, 1, 2, 3
        int sum = list.stream().filter( i -> i<4).distinct().reduce(0,(a,b)->{
        ...
        Map<Integer,Integer> map = list.stream().parallel().collect(Collectors.toMap(a->a,a->(a+(int)(Math.random()*10)),(a,b)->{
            System.out.println("map a的值："+a);
            System.out.println("map b的值："+b);
            return a;
        }, LinkedHashMap::new));
        print(map);
